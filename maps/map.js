let map, directionsService, directionsRenderer, origin = null, userMarker = null, navigating = false, placesService;
...
function showInfo(placeId, location) {
  placesService.getDetails({
    ...
    if (place.rating != null) {
      ...
      rd.className = 'rating';
      rd.textContent = place.rating + ' ★ (' + (place.user_ratings_total||0) + ')';
      d.appendChild(rd);
    }
...
function init() {
  ...
  directionsRenderer = new google.maps.DirectionsRenderer({
    map, polylineOptions: { strokeWeight: 6 }
  });
