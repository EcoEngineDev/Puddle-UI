...
class MapsPage(QWebEnginePage):
    def __init__(self, profile, parent=None):
        ...
        # Enable all settings for maps functionality
        ...
        settings.setAttribute(QWebEngineSettings.WebGLEnabled, True)  # Important for maps
...
class MapsWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.profile = QWebEngineProfile("maps_profile")
    ...
    def setup_ui(self):
        ...
        # Create web view for Maps
        self.web_view = QWebEngineView()
        self.page = MapsPage(self.profile, self.web_view)
